...
def create_graph_routes(rag, api_key: Optional[str] = None):
    ...
    async def get_graph_labels():
        ...
        """
        try:
            return await lightrag.get_graph_labels()
    ...
    async def get_popular_labels(
        ...
        """
        try:
            return await lightrag.chunk_entity_relation_graph.get_popular_labels(limit)
        except Exception as e:
    ...
    async def search_labels(
        ...
        """
        try:
            return await lightrag.chunk_entity_relation_graph.search_labels(q, limit)
        except Exception as e:
    ...
    async def get_knowledge_graph(
        ...
        try:
            ...
            return await lightrag.get_knowledge_graph(
                node_label=label,
                max_depth=max_depth,
                max_nodes=max_nodes,
            )
    ...
    async def check_entity_exists(
        ...
        """
        try:
            exists = await lightrag.chunk_entity_relation_graph.has_node(name)
    ...
    async def update_entity(request: EntityUpdateRequest):
        ...
        """
        try:
            result = await lightrag.aedit_entity(
    ...
    async def update_relation(request: RelationUpdateRequest):
        ...
        """
        try:
            result = await lightrag.aedit_relation(
    ...
    async def create_entity(request: EntityCreateRequest):
        ...
        try:
            ...
            result = await lightrag.acreate_entity(
                entity_name=request.entity_name,
    ...
    async def create_relation(request: RelationCreateRequest):
        ...
        try:
            ...
            result = await lightrag.acreate_relation(
