...
class StorageNotInitializedError(RuntimeError):
    ...
    def __init__(self, storage_type: str = "Storage"):
        super().__init__(
            ...
            f"\n"
            f"  rag = LightRAG(...)\n"
            f"  await lightrag.initialize_storages()  # Required - auto-initializes pipeline_status\n"
            f"\n"
...
class PipelineNotInitializedError(KeyError):
    ...
    def __init__(self, namespace: str = ""):
        msg = (
            ...
            f"\n"
            f"  1. You called await lightrag.initialize_storages()\n"
            ...
            f"  await lightrag.initialize_storages()  # Auto-initializes pipeline_status\n"
            f"\n"
